...
import net.ladstatt.apps.plasma.MathUtil.{sin, cos}
...
abstract class PlasmaBase[A](width: Int, height: Int, blockSize: Int)
  ...
  def paintPixel(backingArray: A
    ...
    def plasmaEffect(time: Double, colX: Double, colY: Double) = {
    ...
    writeBackingArray(backingArray, x, y, red, green, blue, alpha)
